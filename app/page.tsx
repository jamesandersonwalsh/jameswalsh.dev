  ...
  return (
    <>
      <div className="mb-10 flex flex-col items-center">
        <div className="flex max-w-prose flex-col items-center gap-2 text-center sm:h-screen">
          <TypographyH1 className="ease my-6 text-4xl md:my-3 md:text-6xl">Hey 👋🏻 I&apos;m James</TypographyH1>
          <TypographyP className="ease my-3 text-lg">
            I&apos;m a full-stack Software Engineer, UI/UX enthusiast, full time tinkerer, & self-proclaimed developer
            advocate.
          </TypographyP>
          <TypographyP className="ease mb-4 text-lg">
            I currently focusing on creating web platform tools. I&apos;m also an indie developer, gamer, & developer
            blogger. You can read my&nbsp;
