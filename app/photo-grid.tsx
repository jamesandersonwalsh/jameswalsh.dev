    ...
    <div className="columns-2 gap-4 sm:columns-3">
      <div className="relative mb-4 h-40">
        <Image
          ...
          width={160}
          height={160}
          className="mb-4 rounded-lg opacity-0 shadow-xl transition-opacity delay-1000 duration-500"
      ...
      <div className="relative mb-4 md:h-72">
        <Image
          ...
          width={160}
          height={160}
          className="rounded-lg opacity-0 shadow-xl transition-opacity delay-1300 duration-500"
          onLoad={(image) => image.currentTarget.classList.remove('opacity-0')}
        />
      </div>
      ...
      <div className="relative mb-4 h-40">
        <Image
          ...
          width={160}
          height={160}
          className="rounded-lg opacity-0 shadow-xl transition-opacity delay-1500 duration-500"
          onLoad={(image) => image.currentTarget.classList.remove('opacity-0')}
        />
      </div>
      <div className="relative mb-4 h-40">
        <Image
          ...
          width={120}
          height={120}
          className="w-full rounded-lg opacity-0 shadow-xl transition-opacity delay-1200 duration-500"
          onLoad={(image) => image.currentTarget.classList.remove('opacity-0')}
        />
      </div>
      <div className="relative mb-4 h-72">
        <Image
          ...
          width={160}
          height={160}
          className="rounded-lg opacity-0 shadow-xl transition-opacity delay-1700 duration-500"
          onLoad={(image) => image.currentTarget.classList.remove('opacity-0')}
        />
      </div>
    </div>
