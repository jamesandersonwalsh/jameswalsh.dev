...
description: As both a Mac & Windows Guy, it's been no walk in the park trying to develop Node.js services on Windows devices. Especially compared to the relatively seamless experience on both Mac & Linux. But with the Windows Sub System for Linux rapidly gaining popularity, now's an excellent time to jump into getting a great dev environment setup on your gaming rig.
...
![Using a mac as a track pad](/blog-images/mac-guys-guide/gaming-on-a-mac.avif)
...
![Dongle Hell](/blog-images/mac-guys-guide/dongle-hell.webp)
...
![Ubuntu App](/blog-images/mac-guys-guide/microsoft-store-ubuntu.webp)

1. Install the new [Windows Terminal app](https://www.youtube.com/watch?v=8gw0rXPMMPE) from the Windows Store.

   ![Terminal App](/blog-images/mac-guys-guide/terminal-app.webp)

The new terminal app is **sleek**. It's minimal, it stays out of the way, it actually supports re-sizing _(cough cough command prompt)_, and here's the best part... If you have WSL installed it has automatic support for WSL. Just open a new WSL tab and _boom_. You're running Linux.
...
3. Use VSCode.
4. Switch between gaming & coding like an absolute bad ass.
5. Profit.

I had such a great experience switching to this setup that I was even able to generate a super small side project completely in windows with my Mac tightly closed in my backpack. I took plenty of gaming breaks because for the first time... _I could_.
